<template>
  ...
  >
    ...
    >
      <div class="lg:w-1/3">
        <div class="flex items-center space-x-2">
          ...
          <h1 class="self-center text-2xl font-semibold">Juvencio Figo</h1>
        </div>
        ...
        <span name="attribution 1" class="text-xs text-gray-400"
          >          <a href="https://github.com/juvenciofigo" target="_blank">Jucencio Figo</a></span
        >
      </div>
    ...
    <div class="py-3 text-center text-sm">© 2025 Juvencio Figo.</div>
  </footer>
</template>
