    ...
    <div class="content mt-10">
      ...
      <div class="flex w-full flex-col gap-y-5">
        ...
        <span class="text-center">
          ...
          <div class="flex w-full flex-col items-center justify-center gap-2 pt-3">
            <div class="flex items-center">
              ...
              >
                ...
                <span
                  v-else
                  class="juvenciofigo@gmail.com source-sans flex items-center gap-x-1 text-base"
                >
                  <svg
...
const email = 'juvenciofigo@gmail.com'
